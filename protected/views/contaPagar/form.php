          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Criar <small>Conta a Pagar</small></h3>
              </div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form method="post" action="../../controllers/ContaPagarController.php" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" onsubmit="return validateForm()">
